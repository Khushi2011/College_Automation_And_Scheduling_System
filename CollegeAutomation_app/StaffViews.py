...
from CollegeAutomation_app.models import CustomUser, Staffs, Courses, Subjects, Students,LeaveReportStaff, FeedBackStaffs,StudentResult, Attendance, AttendanceReport
